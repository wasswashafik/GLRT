...
%% initialize
Y = D;
%% computes the K largest singular values(where K=1)
...
stopCriterion = 1;
sv = 10;  
%% sv is the dimension of the  predicted principal singular space whose singular values are larger than a given threshold.
while ~converged       
    iter = iter + 1;
    % update E
