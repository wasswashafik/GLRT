...
for nn = 1:runs_pfa
    ...
    %%  2S-GLRT
    BB = X1.'*X1 ;
    [x2,y2] = eig(BB);% Find the eigenvalues and eigenvectors of the matrix, x is the eigenvector matrix, and y is the eigenvalue matrix.
...
for ii = 1 : SNRpoint
    ...
    for n = 1 : runs
        ...
        %%  2S-GLRT
        BB = X1.'*X1 ;
        [x2,y2] = eig(BB);% Find the eigenvalues and eigenvectors of a matrix, where x is the eigenvector matrix and y is the eigenvalue matrix.
        eigenvalue2 = diag(y2);% find the diagonal vector
