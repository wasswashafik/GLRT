...
%%
figure(2);
% Attributes ['plotstyle','compact']['colorgroup',g2,]['color','rk']
...
% ylim([0,0.0065])  %Control of the coordinate axis display range for the y-axis

Xtick_pos = (1:num_meth)+0.15; % Determine where the label is displayed
Xtick_label  ={'GRX','LRX','CRD','RPCA-RX','GTVLRR','2S-GLRT'};
set(gca,'XTickLabel',Xtick_label, 'XTick',Xtick_pos); % Can set font properties ['fontsize',15]
% xtickangle(15) % Rotate label angle
...
%% Maximum and Minimum£¨Box-whisker highs and lows£ºwhisker for 0-100%£©
...
% Top and bottom edges of the box (abnormal, background area 10% and 90% stats)
